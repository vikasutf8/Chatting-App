...
import { addMembers, getChatDetail, getMyChats, getMyGroups, leaveGroup, newGroupChat, removeMember, sendAttachments } from '../controllers/chat.controller.js';
...
router.route("/:_id").get(getChatDetail).put().delete();
